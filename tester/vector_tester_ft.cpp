...
VectorTesterFt::VectorTesterFt(): cnt(NULL), method(DEFAULT), size(100), headers(false), _stop(false), __out("ft.txt") {}
...
VectorTesterFt::iterator VectorTesterFt::getRandomIterator(int chance = 1) {
