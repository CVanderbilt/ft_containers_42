...
MapTesterFt::MapTesterFt(): cnt(NULL), method(DEFAULT), size(100), headers(false), _stop(false), __out("ft.txt") {}
...
MapTesterFt::iterator MapTesterFt::getRandomIterator(int chance = 1) {
